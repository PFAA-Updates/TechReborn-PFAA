...
public class RecipesStandalone implements ICompatModule {
    ...
    static void addTRRecipes() {
        ...
        CraftingHelper.addShapedOreRecipe(
            ...
            'C',
            ItemParts.getPartByName("heliumCoolantSimple"),
            'T',
            "ingotTungsten",
            'I',
            "plateIridium");
        ...
        CraftingHelper.addShapedOreRecipe(
            ...
            "FHF",
            'H',
            new ItemStack(ModItems.parts, 1, 17),
            'C',
            "circuitAdvanced",
            'B',
            new ItemStack(ModBlocks.MachineCasing, 1, 2),
        ...
        CraftingHelper.addShapedOreRecipe(
            ...
            "circuitMaster",
            'M',
            new ItemStack(ModItems.parts, 1, 39));
        ...
        CraftingHelper.addShapedOreRecipe(
            ...
            "CGC",
            'P',
            ItemPlates.getPlateByName("tungstensteel"),
            'T',
            new ItemStack(ModBlocks.MachineCasing, 1, 2),
            'G',
            new ItemStack(Blocks.furnace),
        ...
        if (ConfigTechReborn.UUrecipesIridiamOre) CraftingHelper
            .addShapedOreRecipe(ItemIngots.getIngotByName("iridium"), "UUU", " U ", "UUU", 'U', ModItems.uuMatter);
