...
public class TechRebornConfigGui extends GuiConfig {
    ...
    public static class TRGeneral extends CategoryEntry {
        ...
        public TRGeneral(GuiConfig owningScreen, GuiConfigEntries owningEntryList,
            @SuppressWarnings("rawtypes") IConfigElement configElement) {
    ...
    public static class TRWORLD extends CategoryEntry {
        ...
        public TRWORLD(GuiConfig owningScreen, GuiConfigEntries owningEntryList,
            @SuppressWarnings("rawtypes") IConfigElement configElement) {
            super(owningScreen, owningEntryList, configElement);
        }
    ...
    public static class TRPOWER extends CategoryEntry {
        ...
        public TRPOWER(GuiConfig owningScreen, GuiConfigEntries owningEntryList,
            @SuppressWarnings("rawtypes") IConfigElement configElement) {
            super(owningScreen, owningEntryList, configElement);
        }
    ...
    public static class TRCRAFTING extends CategoryEntry {
        ...
        public TRCRAFTING(GuiConfig owningScreen, GuiConfigEntries owningEntryList,
            @SuppressWarnings("rawtypes") IConfigElement configElement) {
            super(owningScreen, owningEntryList, configElement);
        }
    ...
    public static class TRUU extends CategoryEntry {
        ...
        public TRUU(GuiConfig owningScreen, GuiConfigEntries owningEntryList,
            @SuppressWarnings("rawtypes") IConfigElement configElement) {
            super(owningScreen, owningEntryList, configElement);
        }
    ...
    public static class TREMC extends CategoryEntry {
        ...
        public TREMC(GuiConfig owningScreen, GuiConfigEntries owningEntryList,
            @SuppressWarnings("rawtypes") IConfigElement configElement) {
            super(owningScreen, owningEntryList, configElement);
        }
    ...
    public static class TRINT extends CategoryEntry {
        ...
        public TRINT(GuiConfig owningScreen, GuiConfigEntries owningEntryList,
            @SuppressWarnings("rawtypes") IConfigElement configElement) {
            super(owningScreen, owningEntryList, configElement);
        }
