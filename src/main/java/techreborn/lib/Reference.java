...
public class Reference {
    ...
    public static String assemblingMachineRecipe = StatCollector
        .translateToLocal("techreborn.recipe.assemblingmachine");
    ...
    public static String implosionCompressorRecipe = StatCollector
        .translateToLocal("techreborn.recipe.implosioncompressor");
    public static String industrialElectrolyzerRecipe = StatCollector
        .translateToLocal("techreborn.recipe.industrialelectrolyzer");
    public static String industrialSawmillRecipe = StatCollector
        .translateToLocal("techreborn.recipe.industrialsawmill");
    public static String latheRecipe = StatCollector.translateToLocal("techreborn.recipe.lathe");
    public static String plateCuttingMachineRecipe = StatCollector
        .translateToLocal("techreborn.recipe.platecuttingmachine");
