...
public class ItemFuelRod extends Item implements IReactorComponent, IBoxable {
            ...
            if (!ItemArmorHazmat.hasCompleteHazmat(entity)) {
                ...
                entity.addPotionEffect(
                    new PotionEffect(
                        ...
                        radiation * 180 * stack.stackSize + Math.max(
                            0,
                            ((effect = entity.getActivePotionEffect(IC2Potion.radiation)) == null ? 0
                                : effect.getDuration())),
    ...
    private int checkPulsable(IReactor reactor, int youX, int youY, ItemStack pulsingStack, int pulseX, int pulseY,
        ...
        return (stack != null && stack.getItem() instanceof IReactorComponent
            && ((IReactorComponent) stack.getItem())
