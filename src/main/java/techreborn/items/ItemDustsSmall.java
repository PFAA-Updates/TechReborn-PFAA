...
public class ItemDustsSmall extends ItemTR {
    ...
    public static ItemStack getSmallDustByName(String name, int count) {
        ...
        if (meta == -1) throw new IllegalArgumentException("The small dust " + name + " could not be found.");
    ...
    public static final String[] types = new String[] { "almandine", "aluminium", "andradite", "ashes", "basalt",
        ...
        "glowstone", "gold", "grossular", "gunpowder", "invar", "iron", "lazurite", "lead", "magnesium", "manganese",
        "marble", "netherrack", "nickel", "obsidian", "olivine", "osmium", "peridot", "platinum", "plutonium", "pyrite",
        "pyrope", "redGarnet", "redrock", "redstone", "ruby", "saltpeter", "sapphire", "sawDust", "silver", "sodalite",
        "spessartine", "sphalerite", "steel", "sulfur", "thorium", "tin", "titanium", "tricalciumPhosphate", "tungsten",
        "uranium", "uvarovite", "yellowGarnet", "zinc" };
